    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
          SvgPicture.asset("assets/images/login.svg",width: double.infinity,height: 200,matchTextDirection: true,),
            ...
            Container(
              margin: EdgeInsets.all(tinySpacing),
              child: textFieldCustom(controller: controller, label: "الاسم", hint: "ادخل اسمك", suffix: Icons.person_outlined, kbtype: TextInputType.text,obscure:false,),
            ),
            
            Container(
              margin: EdgeInsets.all(tinySpacing),
              child: textFieldCustom(controller: controller, label: "اسم المستخدم", hint: "ادخل اسم المستخدم", suffix: Icons.star_border, kbtype: TextInputType.text,obscure:false,),
            ),
            ...
            Container(
              margin: EdgeInsets.all(tinySpacing),
              child: textFieldCustom(controller: controller, label: "رقم الهاتف", hint: "ادخل رقم الهاتف", suffix: Icons.phone_android_sharp, kbtype: TextInputType.number,obscure:false,),
            ),
            ...
            Container(
              margin: EdgeInsets.all(tinySpacing),
              child: textFieldCustom(controller: controller, label: "الاسم", hint: "ادخل اسمك", suffix: Icons.location_on_outlined, kbtype: TextInputType.text,obscure:false,),
            ),
            
            Container(
              margin: EdgeInsets.all(tinySpacing),
              child: elevatedButtonCustom(func: (){}, text: "الذهاب الى التحقق من التسجيل"),
            ),
